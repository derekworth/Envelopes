...
public class Transaction {
    ...
    public Transaction(int id) {
        try {
            ...
            try (Connection conn = DriverManager.getConnection(URL); Statement stmt = conn.createStatement()) {
                ...
                this.acct = new Account(rs.getInt("acctid"));
    ...
    public String setAmount(double newAmt) {
    ...
    String setTransferTransaction(int txID) {
        if (!isInDatabase()) {
            return "Error: transaction does not exist in database";
        }
        String ts = Utilities.getTimestamp();
    ...
    public String toString() {
        if (isInDatabase())
            ...
            return "This transaction did not initialize";
    }
}
